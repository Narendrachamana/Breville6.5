...
public class Verify_Adding_EW_toCart_and_Remove_FG extends Actiondriver{
	...
	public void Add_EWtocartandRemoveFG(String data[]) throws Throwable
	{
		...
		brevilleproduct.verifyEmptycartMessage();
