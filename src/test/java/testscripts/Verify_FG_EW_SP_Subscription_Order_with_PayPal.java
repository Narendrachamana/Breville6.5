...
public class Verify_FG_EW_SP_Subscription_Order_with_PayPal extends Actiondriver {
    ...
    public void verifyCreationOrderWithFG_EW_SP_Subscription(String data[]) throws Throwable {
        ...
        brevilleproduct.verifyOrderwithFG_SC_SP_SB(data[2], data[1], data[3], data[4],data[25], data[26]);
