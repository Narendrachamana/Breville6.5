...
public class CancelSubscription extends Actiondriver {
	
    public static BrevilleMyDashboard_OR brevilleMyDashoard;
    public static BrevilleHomepage_OR brevilleHome;

	@Test
	public void cancelSubscription(String data[]) throws Throwable
	{
        ...
        brevilleMyDashoard.clickonCancelSubscription();
	}
}
