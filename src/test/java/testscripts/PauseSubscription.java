...
public class PauseSubscription  extends Actiondriver {
    public static BrevilleMyDashboard_OR brevilleMyDashoard;
    public static BrevilleHomepage_OR brevilleHome;

    @Test
	public void pauseSubscription(String data[]) throws Throwable
	{
        ...
        brevilleMyDashoard.selectTimeframeToPauseSubscription(1);
	}	
}
